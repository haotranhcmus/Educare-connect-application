...
class EducareIepPlanRejectWizard(models.TransientModel):
    ...
    rejection_reason = fields.Selection(
        selection=[
            ('incomplete_goals', 'Incomplete goals'),
    ...
    def action_confirm_reject(self):
        ...
        reason_label = dict(self._fields['rejection_reason'].selection).get(self.rejection_reason)
        ...
        self.plan_id.with_context(skip_status_transition_check=True, skip_auto_status_flow=True).write({
            'status': 'draft',
