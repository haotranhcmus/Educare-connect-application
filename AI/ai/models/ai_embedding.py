...
class AIEmbedding(models.Model):
    ...
    # Define database indexes using Odoo's _table_indexes
    _table_indexes = [
        'CREATE INDEX IF NOT EXISTS ai_embedding_vector_idx ON ai_embedding USING ivfflat (embedding_vector vector_cosine_ops)'
    ]
