  ...
  return (
    <ScrollView style={{ backgroundColor: theme.colors.background }}>
      ...
      <View style={styles.section}>
        <InfoGrid
          items={[
            ...
            {
              label: "Nhận báo cáo hàng ngày",
              value: student.receive_daily_report ? "Có" : "Không",
            },
          ]}
        />
      </View>
      ...
      <View style={styles.section}>
        <InfoGrid
          items={[
            { label: "Phong cách học tập", value: student.learning_style },
            { label: "Mức độ giao tiếp", value: student.communication_level },
            {
